...
// Challenge: using the Array.prototype.filter() method, filter through the presidents array and console.log only the presidents who were born in the 1900s
const result = presidents.filter(president => president.year >= 1800 && president.year < 1900);

console.log(result);

// alternatively
const birthYear = presidents.filter(function(president){
